<template>
  <div class="form-container">
    <!-- Display SIN Number from Completed Construction Form -->
    <div class="form-row">
    ...
    async saveData() {
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Updated: Prepare data with proper structure and validation
          const combinedData = {
          ...
          console.log(
            "Sending combined construction and usage data:",
          ...
          sessionStorage.setItem("submittedSinNumber", this.sinNumber);

          // Show success message
          Swal.fire({
            icon: "success",
            title: "All Data Saved Successfully!",
            text: `Construction and usage information saved for SIN Number: ${this.sinNumber}`,
          ...
          if (error.response?.status === 400) {
            ...
            if (error.response?.data?.message) {
              if (
                ...
                errorMessage = `The SIN number "${this.sinNumber}" is not verified in the system. Please ensure the airfield form has been properly saved and verified.`;
              } else {
            ...
            errorMessage =
              ...
              "This SIN number already has complete construction data recorded. " +
          ...
          Swal.fire({
            ...
            footer:
              ...
              error.response?.data?.message?.includes(
                ...
                ? "<small>Try going back to verify the SIN number is properly generated in the airfield form.</small>"
                : null,
          });
        } finally {
          this.isSaving = false;
