        ...
        <div class="text-container2">
          ...
          <div class="row">
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
              <h6>Total Entities - Active</h6><br>
              <b style="font-size: 35px;">{{ entityActive }} </b><br />
            </div>
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
              <h6>Total Entities - Inactive</h6><br>
              <b style="font-size: 35px;">{{ entityInActive }} </b><br />
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    this.countEntityActive();
    this.countEntityInActive();
  ...
  methods: {
    countEntityActive() {
      return axios
        .get(resources_files.backend_url_system_management() + '/get/api/production/system/management/backend/restapi/get/entity/details/for/dashboard/1')
        .then(response => {
          this.entityActive = response.data;
    ...
    countEntityInActive() {
      return axios
        .get(resources_files.backend_url_system_management() + '/get/api/production/system/management/backend/restapi/get/entity/details/for/dashboard/0')
        .then(response => {
          this.entityInActive = response.data;
          if (this.entityInActive == "") {
            this.entityInActive = 0;
          }
        }).catch(function (error) {
          return error;
        });
