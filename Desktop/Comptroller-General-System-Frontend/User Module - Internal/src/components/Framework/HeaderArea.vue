      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="h-100 d-flex align-items-center justify-content-center">
            <div>
              <div>
                <h1 style="font-size: 16px;" id="logo" class="logo me-auto d-sm-none d-md-block d-none d-sm-block"><a
                    href="https://www.treasury.gov.lk/">Ministry of Finance, Economic Stabilization & National
                    Policies</a></h1>
              </div>
              <nav id="navbar" class="navbar">
                <ul>
                  ...
                  <li>
                    <a id="headerLink" onclick='window.location.href = "/cgoInternal/"' class="nav-link scrollto"
                      style="cursor: pointer;">|
                      HOME</a>
                  </li>
                  <li>
                    <a id="headerLink" class="nav-link scrollto" href="https://www.treasury.gov.lk">| TREASURY WEB
                      SITE</a>
                  </li>
                    ...
                    <li>
                      <div class="btn-group" id="headerLink">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                          ...
                          &nbsp;
                          <!--<div class="router">
                          <router-link to="/user/manual" tag="button">
                            <font-awesome-icon icon="fa-user-circle-o" /> User Manual
                          </router-link>
                        </div>-->
                          &nbsp;
                          <div class="">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-auto col-md-12 col-sm-12 col-xs-12 " data-aos="fade-up" data-aos-delay="200">
          <h1
            style="color: white; font-weight: 500; font-size: 26px; line-height: 37px; font-family: serif; letter-spacing: 1px; ">
            Government
            Non-Financial<br />Asset Management System</h1>

          <div class="alert alert-primary" role="alert">
            Comptroller General's Office - Sri Lanka
          </div>
          <div v-if="!this.currentUser">
            <router-link to="/login">
              <a class="animated-button1" style="float: none;">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
...
#hero {
  background: rgba(19, 0, 36);
  background-image: url('../../assets/img/MOF_Cover-png.png');
