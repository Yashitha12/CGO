            ...
            <div v-if="!successful">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page"><a
                      onclick='window.location.href = "/cgoInternal/"' class="btn-sm btn-link">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add Divisional Secretariat</li>
                </ol>
              </nav>
...
export default {
  ...
  methods: {
      ...
      this.$swal.fire(
        {
          ...
          if (result.isConfirmed) {
            ...
            district_ds_gn_service.saveDivisionalSecretariat(data).then(
              (response) => {
    ...
    changeMessageActive() {
      ...
      return axios
        .get(resources_files.backend_url_internal() + '/get/api/production/user/internal/backend/restapi/get/one/contdistrict/' + this.dataParam)
        .then(response => {
