    ...
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <hr>
          <div v-if="!successful2 && userRoles.includes('ADMIN') || userRoles.includes('USERS_MANAGEMENT_EXTERNAL_OFFICER')">
            <button class="btn btn-danger btn-block" :disabled="loading" @click="handlePasswordReset">
      ...
      <div class="card card-container">
        <nav aria-label="breadcrumb" >
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Access Deatails</li>
          </ol>
        </nav>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <Field name="role" class="form-control" as="select" multiple size="8" v-model="items2.roles">
                      ...
                      <option value="Verification_Officer">Data Verification Officer</option>
        ...
        <div class="a-box align-self-center">
          <div class="card card-container">
            <Form @submit="handleSave" :validation-schema="schema1">
              ...
              <Field name="entityId" type="hidden" class="form-control" v-model="items.entityId" />
              <Field name="attachmentOfficeId" type="hidden" class="form-control" v-model="items.attachmentOfficeId" />
              <Field name="attachmentRequestLetter" type="hidden" class="form-control"
                v-model="items.attachmentRequestLetter" />
                ...
                <div class="form-group row d-none">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <Field name="lastName" type="text" class="form-control" v-model="items.lastName" readonly="true" />
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <Field name="status" class="form-control" as="select" v-model="items.status">
                        ...
                        <option value="2">RESUBMISSION STATE</option>
                      </Field>
      ...
      this.$swal.fire(
        {
          ...
          if (result.isConfirmed) {
            ...
            UserService.updateProfileSuperAdminExternalStaff(data).then(
              (response) => {
      ...
      this.$swal.fire(
        {
          ...
          if (result.isConfirmed) {
            ...
            this.$store.dispatch("auth/updatePermissionsExternal", user).then(
              (data) => {
      ...
      this.$swal.fire(
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            UserService.passwordReset(this.dataParam).then(
              (response) => {
