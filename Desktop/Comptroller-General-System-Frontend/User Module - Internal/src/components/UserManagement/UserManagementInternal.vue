<template>
  <div class="row">
    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
      <hr />
      <router-link to="/register/user/internal">
        <button type="button" class="btn btn-success btn-lg">Register New Staff User</button>
      </router-link>
      <hr />
    </div>
  </div>
              ...
              <div class="text-container">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">List of Staff Users - Activated</li>
                  </ol>
                </nav>
                <br />
                <div class="row">
                ...
                <div>
                  <table style="text-align: left;" class="table">
                    ...
                    <tr v-for="item in itemsActive" :key="item">
                      ...
                      <router-link :to="{ name: 'UserManagementView', params: { id: item.userId } }"
              ...
              <div class="text-container">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page"><a
                        onclick='window.location.href = "/cgoInternal/"' class="btn-sm btn-link">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">List of Staff Users - Not Activated</li>
                  </ol>
                </nav>
                <hr />
                <div class="row">
...
export default {
  ...
  methods: {
    activatedList() {
      ...
      return axios
        .get(resources_files.backend_url_internal() + '/api/auth/restapi/get/user/details/pagable/logs/' + this.pageAttributeActive + "/" + "3" + "/" + this.pageLenthActive)
        .then(response => {
    ...
    inactivatedList() {
      ...
      return axios
        .get(resources_files.backend_url_internal() + '/api/auth/restapi/get/user/details/pagable/logs/' + this.pageAttributeInActive + "/" + "0" + "/" + this.pageLenthInActive)
        .then(response => {
